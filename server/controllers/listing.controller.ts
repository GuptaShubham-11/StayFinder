...
const getListingById = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, 'Listing fetched successfully.', listing));
});
...
const updateListing = asyncHandler(async (req: AuthenticatedRequest, res) => {
    ...
    res.status(200).json(new ApiResponse(200, 'Listing updated successfully.', listing));
});
